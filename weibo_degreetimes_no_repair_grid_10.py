...
ax22.clear()
ax22.scatter(x,y,marker='o',c='darkblue',edgecolors='',linewidths=1,s=50,alpha=0.6)
ax22.loglog()
...
ax22.set_ylabel('$\Lambda$',color='k',fontsize=textsize,labelpad=15,rotation=0,alpha=1)
ax22.text(-0.27,1.10,'e',color='k',fontsize=textsize,fontweight='bold',rotation=0,alpha=1,transform=ax22.transAxes)
ax22.text(0.65, 0.15,'$\\alpha=-0.73(2)$',fontsize=ticksize,color='k',fontweight='normal',rotation=0,alpha=1,transform=ax22.transAxes)
ax22.text(0.65, 0.05,'$\\beta=-0.47(2)$',fontsize=ticksize,color='k',fontweight='normal',rotation=0,alpha=1,transform=ax22.transAxes)
ax22.text(0.05, 0.90,'$R^2=0.93$',fontsize=ticksize,color='k',fontweight='normal',rotation=0,alpha=1,transform=ax22.transAxes)
...
ax22 = plt.subplot(235)
ax22.clear()
ax22.scatter(x_repair,y_repair,marker='o',c='darkblue',edgecolors='',linewidths=1,s=20,alpha=0.6)
ax22.loglog()
...
ax22.text(0.45, 0.15,'$\\alpha=-0.04(2)$',fontsize=ticksize,color='k',fontweight='normal',rotation=0,alpha=1,transform=ax22.transAxes)
ax22.text(0.45, 0.05,'$\\beta=-0.46(2)$',fontsize=ticksize,color='k',fontweight='normal',rotation=0,alpha=1,transform=ax22.transAxes)
ax22.text(0.05, 0.90,'$R^2=0.82$',fontsize=ticksize,color='k',fontweight='normal',rotation=0,alpha=1,transform=ax22.transAxes)
